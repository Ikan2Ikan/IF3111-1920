...
<body>
	...
	<div class="border">
		<div class="postengah">
			...
			<h5><a href="<?php echo base_url(''); ?>auth/Buat_Laporan">Buat Laporan/Komentar</a></h5>
		</div>
		...
		foreach ($user as $data) {
			...
			<p class="poskiri">Lampiran :
				...
				<span class="poskanan"> waktu :
					...
					<a class="spasi" href="<?php echo base_url('auth/BacaSelengkapnya/') . $data->id ?>">Baca Selengkapnya</a>
				</span>
				<hr>
			</p>
