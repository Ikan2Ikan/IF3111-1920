...
`Pada tubes ini kami menggunakan framework PHP CodeIgniter versi 3. Cara menginstalnya sangat mudah pertama harus mendownload file CI nya lalu ekstrak dan pindahkan ke folder htdocs.`

`Setelah itu kami membuat folder pages dalam application\view. Didalam folder peges kami membuat 4 halaman yang mewakili dari proses CRUD`

`Pada folder application\models kami membuat file control_model.php dimana fungsinya yaitu untuk menghandle langsung database`

`Pada folder application\controllers kami membuat file Control.php dimana fungsinya yaitu sebagai jembatan antara model dan view`

`Kami juga membuat folder assets dimana terdapat 2 folder lagi didalamnya yaitu css berfungsi untuk styling html dan js untuk validasi form inputan`

`Kami juga membuat folder lampiran yang berfungsi untuk menyimpan file dari lampiran yang diinputkan`
