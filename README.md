...
- Install Aplikasi Xampp di Laptop anda (Jika Belum ada).
- Pindahkan folder hasil ekstrak tadi ke folder c:/xampp/htdocs (Agar dapat melihat hasil)
- Jalankan Aplikasi Xampp, aktifkan module Apache dan MySQL
- Bukan Browser dan jalankan alamat "localhost/IF3111-1920/LAPOR"
- Selesai.
